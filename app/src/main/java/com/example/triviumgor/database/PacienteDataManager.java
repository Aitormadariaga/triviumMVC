...
public class PacienteDataManager {
    ...
    // ======= MÉTODOS PARA Sincronizacion =======
    public void guardarPacientesDesdeServidor(JSONArray pacientes) throws Exception {
        // Obtener IDs de eliminaciones pendientes para filtrarlos
        ...
        try {
            ...
            for (int i = 0; i < pacientes.length(); i++) {
                ...
                // Si está pendiente de eliminar → saltarlo
    ...
    // ======= MÉTODOS PARA ELIMINACIONES PENDIENTES =======
